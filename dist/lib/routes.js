...
var api = require('./controllers/api'),
    ...
    //nools = require('./controllers/nools')
...
module.exports = function(app) {
  ...
  app.get('//api/routes/getFollowingRoutes', routes.getFollowingRoutes);
  app.post('//api/routes/unfollowRoute', routes.unfollowRoute);
  app.post('//api/routes/followRoute', routes.followRoute);
  app.get('//api/routes/getRecommendation', routes.getRecommendation);
